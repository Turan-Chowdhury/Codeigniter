...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="front-end/front-end/img/favicon.ico">
	<!-- end: Favicon -->
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url().'/add-student'?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Student</span></a></li>
